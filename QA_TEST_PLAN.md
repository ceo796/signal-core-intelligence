...
- [ ] T41 Shared sidebar + dashboard polish: full 7-item sidebar visible on Home, Documents, Ask, Compare, Brief, Activity pages; Collections/Agents/Workflows/Settings open coming-soon modal; ask-bar caret padded; Recent Briefs shows honest empty state; Ask page shows pre-filled query banner when navigated from dashboard; no backend changes
