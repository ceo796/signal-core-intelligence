...
// Shared grounding + reasoning policy. Reasoning uses Gemini first, Grok second, then local
// extractive fallback — never OpenAI. It grounds answers in the user's documents (with [Source N]
// citations) and may supplement with general AI reasoning when the documents fall short — clearly
// labeled, and never implying any web/external/real-time source (there is no web access here).
